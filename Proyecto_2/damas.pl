...
comerDeNuevo(X1,Y1,X2,Y2) :- posicionValida(X2,Y2), not(casillaVacia(X2,Y2)), ficha(X1,Y1,Z), turno(W), apply(W, [F,Z]), moverFicha(X1,Y1,X2,Y2,F).

moverFicha(X1,Y1,X2,Y2,peon)    :-  casillaVacia(X2,Y2), movimientoValido(X1,Y1,X2,Y2,peon,_), moverVacio(X1,Y1,X2,Y2).
moverFicha(X1,Y1,X2,Y2,peon)    :-  turno(W), verificarCasilla(X2,Y2,W), movimientoValido(X1,Y1,X2,Y2,peon,Z), comerFicha(X1,Y1,X2,Y2,Z).

moverFicha(X1,Y1,X2,Y2,rey)    :-  casillaVacia(X2,Y2), movimientoValido(X1,Y1,X2,Y2,rey,_), moverVacio(X1,Y1,X2,Y2).
moverFicha(X1,Y1,X2,Y2,rey)    :-  turno(W), verificarCasilla(X2,Y2,W), movimientoValido(X1,Y1,X2,Y2,rey,Z), comerFicha(X1,Y1,X2,Y2,Z).
...
comerFicha(X1,Y1,X2,Y2,derecha)  :- X3 is X2 + 1, Y3 is Y2 + 1, posicionValida(X3,Y3), casillaVacia(X3,Y3), buscarFicha(X1,Y1,X3,Y3,Z), retract(ficha(X1,Y1,_)), retract(ficha(X2,Y2,_)), assert(ficha(X3,Y3,Z)), repetirJugada(X3,Y3) , !.
comerFicha(X1,Y1,X2,Y2,izquierda)  :- X3 is X2 + 1, Y3 is Y2 - 1, posicionValida(X3,Y3), casillaVacia(X3,Y3), buscarFicha(X1,Y1,X3,Y3,Z), retract(ficha(X1,Y1,_)), retract(ficha(X2,Y2,_)), assert(ficha(X3,Y3,Z)), repetirJugada(X3,Y3), !.
comerFicha(X1,Y1,X2,Y2,antiderecha)  :- X3 is X2 - 1, Y3 is Y2 + 1, posicionValida(X3,Y3), casillaVacia(X3,Y3), buscarFicha(X1,Y1,X3,Y3,Z), retract(ficha(X1,Y1,_)), retract(ficha(X2,Y2,_)), assert(ficha(X3,Y3,Z)), repetirJugada(X3,Y3), !.
comerFicha(X1,Y1,X2,Y2,antizquierda)  :- X3 is X2 - 1, Y3 is Y2 - 1, posicionValida(X3,Y3), casillaVacia(X3,Y3), buscarFicha(X1,Y1,X3,Y3,Z), retract(ficha(X1,Y1,_)), retract(ficha(X2,Y2,_)), assert(ficha(X3,Y3,Z)), repetirJugada(X3,Y3), !.
...
diagonalDerecha(X1,Y1,X2,Y2)    :- X2 > X1, Y2 > Y1, X3 is X2 - X1, Y3 is Y2 - Y1, Y3 =:= X3, X4 is X1 + 1, Y4 is Y1 + 1, caminoLibre(X4,Y4,X2,Y2,derecha).
diagonalIzquierda(X1,Y1,X2,Y2)    :- X2 > X1, Y1 > Y2, X3 is X2 - X1, Y3 is Y1 - Y2, Y3 =:= X3, X4 is X1 + 1, Y4 is Y1 - 1, caminoLibre(X4,Y4,X2,Y2,izquierda).
antidiagonalDerecha(X1,Y1,X2,Y2)    :- X1 > X2, Y2 > Y1, X3 is X1 - X2, Y3 is Y2 - Y1, Y3 =:= X3, X4 is X1 - 1, Y4 is Y1 + 1, caminoLibre(X4,Y4,X2,Y2,antiderecha).
antidiagonalIzquierda(X1,Y1,X2,Y2)    :- X1 > X2, Y1 > Y2, X3 is X1 - X2, Y3 is Y1 - Y2, Y3 =:= X3, X4 is X1 - 1, Y4 is Y1 - 1, caminoLibre(X4,Y4,X2,Y2,antizquierda).
